        ...
        <header className='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
            <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
                ...
                <ul
                    ...
                    <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link to='/product'
                        className='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Product</Link>
                    </li>
                    ...
                    <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link to={'/contact'}
